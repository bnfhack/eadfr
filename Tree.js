...
var Tree = {
  ...
  load: function(id, href) {
    ...
    if (!Tree.main) {
      var nl = document.getElementByTagName('main');
    ...
    if (Tree.aside && sessionStorage) {
      ...
      if (Tree.main) {
        ...
        if (asidewidth) { Tree.aside.style.width = asidewidth + 'px'; Tree.main.style.marginLeft = asidewidth + 'px'; }
        Tree.aside.style.resize = 'horizontal';
        Tree.aside.addEventListener('mousemove', function() { if (this.lastWidth == this.offsetWidth) return; this.lastWidth = this.offsetWidth; Tree.main.style.marginLeft = this.offsetWidth + 'px'; sessionStorage.setItem("asidewidth", this.offsetWidth); }, false); 
